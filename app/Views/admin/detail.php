            ...
            <div class="container-fluid">
                ...
                <form action="/home/save" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mtk" placeholder="Nilai Matematika" name="mtk" value="<?= $detail['mtk']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="bing">Nilai Bahasa Inggris</label>
                        <input type="text" class="form-control" id="bing" placeholder="Bahasa Inggris" name="bing" value="<?= $detail['bing']; ?>" readonly>
                    </div>
                    <img src="<?= base_url('upload/' . $detail['photo']) ?>" />

                    <div class=" col-md-12 text-center">
                        <a href='<?= base_url('/home/admin/') ?>' class="btn btn-primary float-middle">Back</a>
                    </div>
                </form>
