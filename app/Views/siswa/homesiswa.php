...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">PSB SISWA 2021 <sup></sup></div>
        </a>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Selamat Datang Calon Siswa Baru 2021</h1>
                </div>
                ...
                <form action="/home/save" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mtk" placeholder="Nilai Matematika" name="mtk">
                    </div>
                    <div class="form-group">
                        <label for="bing">Nilai Bahasa Inggris</label>
                        <input type="text" class="form-control" id="bing" placeholder="Bahasa Inggris" name="bing">
                    </div>
                    <div class="form-group">
