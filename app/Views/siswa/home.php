        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                    <h1 class="display-4">Terima Kasih, <?= session()->get('name'); ?></h1>
                    <p class="lead">Data Peserta sudah dalam proses verifikasi, tunggu status selanjutnya untuk mengetahui hasil dari proses seleksi </p>
                </div>
                <!-- /.container-fluid -->
